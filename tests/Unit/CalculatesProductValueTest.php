...
class CalculatesProductValueTest extends TestCase
{
     ...
     * @test
     **/
    public function a_products_price_can_be_calculated()
    {
     ...
     * @test
     **/
    public function multiple_products_are_summed()
    {
     ...
     * @test
     **/
    public function a_child_adopts_its_parent_price()
    {
     ...
     * @test
     **/
    public function a_child_will_be_added_to_its_parent_price()
    {
        $parent = Product::factory()->create(['pricing_in_pence' => ['gbp' => 999]]);
