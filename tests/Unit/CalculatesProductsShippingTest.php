...
class CalculatesProductsShippingTest extends TestCase
{
     ...
     * @test
     **/
    public function shipping_can_be_calculated()
    {
     ...
     * @test
     **/
    public function no_shipping_returns_zero()
    {
     ...
     * @test
     **/
    public function shipping_respects_parent_products()
    {
     ...
     * @test
     **/
    public function child_shipping_price_takes_priority()
    {
        $parent = Product::factory()->create(['shipping_in_pence' => ['gbp' => 999]]);
     ...
     * @test
     **/
    public function multiple_products_returns_the_higher_shipping_value()
    {
