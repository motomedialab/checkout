...
class ProductTest extends TestCase
{
     ...
     * @test
     **/
    public function we_can_create_a_product()
    {
     ...
     * @test
     **/
    public function a_product_can_be_owned_by_another_product()
    {
     ...
     * @test
     **/
    public function a_product_can_load_price_based_on_currency()
    {
        /** @var Product $product */
     ...
     * @test
     **/
    public function a_product_with_no_currency_does_something()
    {
     ...
     * @test
     **/
    public function a_variant_loads_price_accounting_for_parent()
    {
     ...
     * @test
     **/
    public function a_variant_with_no_price_adopts_parent_price()
    {
        $parent = Product::factory()->create(['pricing_in_pence' => ['gbp' => 12410]]);
        /** @var Product $child */
        $child = Product::factory()->create([
     ...
     * @test
     **/
    public function a_variant_with_no_parent_price_adopts_variant_price()
    {
